...
interface OnlineWorkshopDescriptionProps {
  description: string;
  onDescriptionChange: (description: string) => void;
}

const OnlineWorkshopDescription: React.FC<OnlineWorkshopDescriptionProps> = ({
  description,
  onDescriptionChange
}) => {
  return (
...
export default OnlineWorkshopDescription; 